...
cmake -B build -GNinja -DCMAKE_C_COMPILER=$(realpath zig-cc.sh) -DCMAKE_C_FLAGS=-isystem$TEMP_INCLUDE_FOLDER -DCMAKE_INSTALL_PREFIX=$INSTALL_PREFIX -DENABLE_STATIC=1
cmake --build build
cmake --install build
